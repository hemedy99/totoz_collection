...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
  ...
  if ($results === 0) {
    ...
    $parameters = [
      'id' => $userReceived->id,
      'userType' => isset($userReceived->userType) ? $userReceived->userType : $results['userType'],
      'firstName' => isset($userReceived->firstName) ? $userReceived->firstName : $results['firstName'],
      'lastName' => isset($userReceived->lastName) ? $userReceived->lastName : $results['lastName'],
      'middleName' => isset($userReceived->middleName) ? $userReceived->middleName : $results['middleName'],
      ...
      'userStatus' => isset($userReceived->userStatus) ? $userReceived->userStatus : $results['userStatus']
